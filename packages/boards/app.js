...
var Boards = new Module('boards');

/*
 * All MEAN packages require registration
 * Dependency injection is used to define required modules
 */
Boards.register(function(app, auth, database) {

  //We enable routing. By default the Package Object is passed to the routes
  Boards.routes(app, auth, database);
  ...
  /*
    ...
    */
  Boards.angularDependencies(['ngCookies', 'ui.bootstrap']);
  Boards.aggregateAsset('css', 'boards.css');
  return Boards;
});
